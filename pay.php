...
// Capture passed Show ID
$showID = $_GET['showID'];
$showName = (isset($_POST['showName'])) ? $_POST['showName'] : '';

// Have they confirmed a ticket purchase?
$confirm = (isset($_POST['confirmed'])) ? $_POST['confirmed'] : '';
  ...
  <body>
    ...
    ?>
      ...
      <div align="center">
        ...
        <form name="form1" id="form1" method="post" action="confirmpurchase2.php?confirmed=1&showID=<?php echo $showID; ?>&showName=<?php echo $showName; ?>">
          <div align="center">
        ...
        ?>
          ...
          <div align="center">
            ...
            <br />
            <span class="smalldark">Your purchased tickets are now reserved. Please enter the data below to confirm purchase and be registered as a subscriber.</span>
            <br /><br />
            <form name="form1" id="form1" method="post" action="process2.php">
