...
<body>
	...
	if ($_POST['signup']) {
		if (!$_POST['firstname'] || !$_POST['lastname'] || !$_POST['email']) {
			echo "<center><span class=errorSubscribe>You forgot to fill in data! <font color=red>(First Name, Last Name, E-mail)</font><br />";
			echo "Click <a href='javascript:history.go(-1)'>HERE</a> to return and correct your mistakes.</span></center>";
			echo "</div>";
			exit;
		}
